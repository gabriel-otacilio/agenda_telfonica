...
contatos = load() # vai retornar a leitura do arquivo
...
def edit_contato(numero_tele, campo_editado,
                 edit):  # estou editando mas depois preciso apagar o antigo e escrever o novo
    ...
    adicionar_contato(nome=contato_dict['nome'], idade=contato_dict['idade'], email=contato_dict['email'],
                      numero_tel=contato_dict['numero de telefone'], endereco=contato_dict['endereço'])
